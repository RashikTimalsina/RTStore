          ...
          <div className="lg:col-span-1 p-8 bg-gray-900 rounded-2xl shadow-2xl border-1-4 sticky top-20 h-fit border border-gray-800">
            <h3 className="text-3xl font-bold text-white mb-5 border-b border-y-gray-700 pb-3 flex items-center space-x-2">
              <div className="flex justify-between">
                <span className="w-12 h-6 text-orange-400">Rs.</span>
            ...
            {cart.length === 0 ? (
              <button
                disabled
                className="w-full mt-8 py-4 bg-gray-700 text-gray-500 font-extrabold text-xl rounded-full cursor-not-allowed uppercase tracking-wider"
              >
                Your cart is empty
              </button>
            ) : (
